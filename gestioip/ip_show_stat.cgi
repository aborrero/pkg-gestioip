...
if ( $stat_host_cats4[0] ) {
	...
	print "</table>\n";
	print "</td>";
	print "<td valign=\"top\"><a href=\"./imagenes/dyn/${hosts4_by_host_cat_im_name}_big.png\"><img src=\"./imagenes/dyn/${hosts4_by_host_cat_im_name}.png\" alt=\"$$lang_vars{hosts4_by_host_cat_message} chart\"></a></td>\n";
	print "</td></tr>\n";
} else {
	print "<tr><td><i><b><font color=\"gray\">N/A</font></b></i></td></tr>\n";
}
...
print "<tr><td colspan=\"2\" align=\"center\"><b>$$lang_vars{hosts6_by_host_cat_message}</b><p></td></tr>\n";
	if ( $stat_host_cats6[0] ) {
		...
		print "</table>\n";
		print "</td>";
		print "<td valign=\"top\"><a href=\"./imagenes/dyn/${hosts6_by_host_cat_im_name}_big.png\"><img src=\"./imagenes/dyn/${hosts6_by_host_cat_im_name}.png\" alt=\"$$lang_vars{hosts6_by_host_cat_message} chart\"></a></td>\n";
		print "</td></tr>\n";
	} else {
		print "<tr><td><i><b><font color=\"gray\">N/A</font></b></i></td></tr>\n";
	}
...
if ( $stat_host_locs4[0] ) {
	...
	print "</table>\n";
	print "</td>";
	print "<td valign=\"top\"><a href=\"./imagenes/dyn/${hosts4_by_host_site_im_name}_big.png\"><img src=\"./imagenes/dyn/${hosts4_by_host_site_im_name}.png\" alt=\"$$lang_vars{hosts4_by_host_site_message} chart\"></a></td>\n";
	print "</td></tr>\n";
} else {
		print "<tr><td><i><b><font color=\"gray\">N/A</font></b></i></td></tr>\n";
}
...
print "<table border=\"0\" cellspacing=\"5\">\n";
	...
	if ( $stat_host_locs6[0] ) {
		...
		print "</table>\n";
		print "</td>";
		print "<td valign=\"top\"><a href=\"./imagenes/dyn/${hosts6_by_host_site_im_name}_big.png\"><img src=\"./imagenes/dyn/${hosts6_by_host_site_im_name}.png\" alt=\"$$lang_vars{hosts6_by_host_site_message} chart\"></a></td>\n";
		print "</td></tr>\n";
	} else {
		print "<tr><td><i><b><font color=\"gray\">N/A</font></b></i></td></tr>\n";
	}
